...
import com.otaz.nytbooksapplication.db.MovieSpecDaoFake
...
class GetMovieTest {
    ...
    private lateinit var bookDaoFake: BookDaoFake
    ...
    fun setup() {
        ...
        bookDaoFake = BookDaoFake(appDatabase)

        searchMovies = SearchMovies(
            movieDao = bookDaoFake,
    ...
    fun getMoviesFromNetwork_getMovieById(): Unit = runBlocking {
        ...
        assert(bookDaoFake.getAllMovies(1, 10).isEmpty())
        ...
        assert(bookDaoFake.getAllMovies(1, 10).isNotEmpty())
